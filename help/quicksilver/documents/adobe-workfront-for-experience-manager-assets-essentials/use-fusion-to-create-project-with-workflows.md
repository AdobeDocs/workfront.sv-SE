...
<table>
  ...
  <tr>
   ...
   <td><p>Medarbetare eller högre</p><p>Begäran eller senare</p></td>
  </tr>
  <tr>
   ...
   <td>
     ...
     <ul>
       <li>
         <p>Du måste ha Experience Manager Assets as a Cloud Service eller Assets Essentials, och du måste läggas till i produkten som användare i Admin Console.</p>
       </li>
       <li>
