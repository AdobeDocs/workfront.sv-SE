...
title: Konfigurera hur Workfront beräknar resurstimme och FTE-tillgänglighet för schemaläggningsområdet
description: Adobe Workfront-administratören avgör hur Workfront beräknar resurstillgänglighet och användartilldelning på systemnivå (med hänsyn till öppettider och FTE) när de konfigurerar inställningar för resurshantering.
author: Alina
...
# Konfigurera hur Workfront beräknar resurstimme och FTE-tillgänglighet för schemaläggningsområdet
...
Adobe Workfront-administratören avgör hur Workfront beräknar resurstillgänglighet och användartilldelning på systemnivå (med hänsyn till öppettider och FTE) när de konfigurerar inställningar för resurshantering.

De kan välja att använda något av följande:
...
* När du tillåter att Workfront automatiskt tilldelar resurser enligt beskrivningen i följande artikel:
...
* När tilldelningsindikatorer visas, enligt beskrivningen i följande artikel:

   * Avsnittet Allokeringsindikatorer i artikeln  [Hantera användarallokeringar i schemaläggningsområdena](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
