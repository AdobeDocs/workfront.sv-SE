...
title: Hantera objekt på [!UICONTROL Views] Sida in [!DNL Workfront Proof]
description: The [!UICONTROL Views] kan du se och arbeta med alla dina korrektur, filer och mappar på ett och samma ställe.
author: Courtney
...
# Hantera objekt på [!UICONTROL Views] Sida in [!DNL Workfront Proof]

>[!IMPORTANT]
>
>Den här artikeln handlar om funktionalitet i den fristående produkten [!DNL Workfront Proof]. Mer information om korrektur inuti [!DNL Adobe Workfront], se [Korrektur](../../../review-and-approve-work/proofing/proofing.md).

The [!UICONTROL Views] kan du se och arbeta med alla dina korrektur, filer och mappar på ett och samma ställe.

## Visar [!UICONTROL Views] Sida

1. Klicka **[!UICONTROL Views]** till vänster.
1. I listrutan (2) klickar du på den vy (3) som du vill se.

![Vyer.png](assets/views-350x297.png)

## Ändra [!UICONTROL Views] Sidlayout

Standardvärdet [!UICONTROL Views] sidlayouten är en miniatyrlista. I den här layouten kan du se en miniatyrbild av varje korrektur, fil (om det går att generera) och mappar (om det är inställt), med annan information i separata kolumner.

1. Klicka på **[!UICONTROL Page Layout]** (1) och sedan den layout du vill använda.

![Views_Page_Layout.png](assets/views-page-layout-350x140.png)

## Ändra [!UICONTROL Views] Lista

Ändra det du ser i dialogrutan [!UICONTROL Views] lista:

1. Klicka på **[!UICONTROL Change view]** -knappen.\
...
1. Klicka på en annan vy i listrutan:
   ...
   * **[!UICONTROL All items]**: Innehåller alla korrektur, filer och mappar som du har behörighet att se. Det är standard när du öppnar [!UICONTROL Views] sida. Du kan välja att inkludera/exkludera arkiverade korrektur i den här vyn.
   * **[!UICONTROL Active items]**: Alla aktiva korrektur, filer och mappar.
   * **[!UICONTROL Active proofs]**: Alla aktiva (ej arkiverade) korrektur som du har behörighet att se.
   ...
   * **Typ**: Ikon för objektet med ikon för korrektur, fil eller mapp
   ...
   * **Ägare**: Namn på den person som äger beviset\
      ...
      Du kan också skapa egna vyer. Se [Skapa och hantera anpassade vyer i [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md) för mer information.
...
1. Klicka på **Visa filter** ikonen längst upp till höger på sidan (1).\
   ![Filter.png](assets/filters-350x107.png)
...
1. Filterfältet visas inte i anpassade vyer som du skapar. För dessa vyer kan du använda och redigera filter i [!UICONTROL Filters] -fliken. Mer information finns i [Skapa och hantera anpassade vyer i [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md).
1. Om du vill använda alla valda filter klickar du på [!UICONTROL Filter] ikon (4) i slutet av filtreringsfältet.\
   ![Filter_2.png](assets/filters-2-350x102.png)

De filtervärden som du väljer fortsätter att gälla tills du ändrar dem. Om du vill visa och få tillgång till den fullständiga listan med objekt igen måste du ändra alla filtervärden tillbaka till standardvärdet, vilket är **[!UICONTROL All]**.

>[!NOTE]
>
>Om du anger filtreringsalternativ och sedan döljer filtreringsfältet genom att klicka på [!UICONTROL Hide filters] ikon (5) visas fältet automatiskt igen om du byter vy. Om du döljer filtreringsfältet medan alla filter är inställda på standardalternativet för alla, förblir filtreringsfältet dolt när du ändrar vyer.

## Sortera objekt

När du skapar ett nytt korrektur (eller en ny version) eller överför en ny fil visas det högst upp i [!UICONTROL All items] lista. Det äldsta objektet visas längst ned i listan.
...
1. Gör något av följande:
   ...
   * Klicka på nedpilen i det övre högra hörnet av [!UICONTROL Views] sida som ska sorteras efter skapandedatum (senaste eller äldsta) eller efter typ, namn, status, beslut eller ägare.\
...
1. Klicka på pilen till vänster om korrekturbilden.\
   ...
   * **Sammanfattning av korrektur**: Dokumentets övergripande status
   * **Scen**: Anger korrekturens deadline och antal beslut som fattats och krävs
   * **Granskare**: Namn, roll och förlopp för respektive granskare visas
...
1. (Valfritt) Om du har redigeringsbehörighet för korrekturet och korrekturet har faser klickar du på **[!UICONTROL More]** (tre punkter) till höger om scenen för att komma åt följande alternativ:

   * **[!UICONTROL Message all]**: Skicka ett e-postmeddelande till alla granskare på scenen.
   * **[!UICONTROL Share]**: Lägg till nya granskare
   * **[!UICONTROL Delete stage]**

1. (Valfritt) Klicka på en granskares **[!UICONTROL More]** (tre punkter) till höger om namnet om du vill göra något av följande:

   * Skicka en påminnelse till granskaren.
   * Redigera granskarens inställningar på korrekturet.\

      I rutan Redigera granskare som visas kan du ändra både roll- och e-postvarningar och visningsnamnet för granskaren. Observera att visningsnamnet bara kan ändras på det aktuella korrekturet, inte i granskarens information på sidan Kontakter. Se [Kontakter](https://support.workfront.com/hc/en-us/sections/115000920808-Contacts) för mer information.
...
The [!UICONTROL All Items] som standard visas alla aktiva och låsta korrektur, filer och mappar. Här finns också möjlighet att inkludera eller exkludera arkiverade korrektur i vyn.\
Så här inkluderar du arkiverade korrektur:

1. När du väljer en vy klickar du på **[!UICONTROL Include archived proofs]**.\
...
1. Gör något av följande i de extra alternativen som visas ovanför visningslistan för de filer som du har markerat:
   ...
   * Klicka på **[!UICONTROL Tags]** om du vill lägga till en tagg till dessa objekt.
   ...
   * Klicka **[!UICONTROL Share selected items]** för att dela alla dessa objekt med andra granskare.\

      ![Share_button-small.png](assets/share-button-small.png)

   * Klicka **[!UICONTROL Delete]** om du vill flytta de markerade objekten till papperskorgen.\

      ![Skräp_knapp.png](assets/trash-button.png)

   * Klicka på **[!UICONTROL More]** för ytterligare åtgärder.

   * Åtgärderna tillämpas bara på de av de markerade objekten som har det särskilda alternativet tillgängligt. Om du t.ex. markerar filer och korrektur och väljer [!UICONTROL Lock]kommer bara korrektur att låsas (eftersom du inte kan låsa filer)

## Flytta ett objekt till en mapp

Om du har redigeringsbehörighet att göra det kan du flytta korrektur, filer och mappar till specifika mappar på [!UICONTROL Views] sida.
...
1. Gör något av följande:
   ...
   * Om du vill flytta flera objekt samtidigt kan du markera kryssrutorna till vänster om objekten och sedan klicka på **[!UICONTROL Move to]**ovanför listan och välj sedan den mapp där du vill placera dem eller skapa en ny mapp för dem.
