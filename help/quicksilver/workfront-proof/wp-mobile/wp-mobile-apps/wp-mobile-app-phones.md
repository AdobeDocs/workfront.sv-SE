...
description: Läs mer om mobilappen Workfront Proof.
hide: true
hidefromtoc: true
...
Du behöver inte vara användare av [!DNL Workfront Proof] (dvs. ha dina egna inloggningsuppgifter) för att granska och godkänna ett bevis via iOS-appen. Så länge du laddar ned appen till din iOS-enhet och når din personliga URL via din iOS-e-postapp kan du granska och godkänna den var du än är.
...
Ladda ned [!DNL Workfront Proof] Mobilappen direkt från [Apple App Store](https://itunes.apple.com/us/app/workfront-proof/id1030372728?mt=8) eller [Google Play Store](https://play.google.com/store/apps/details?id=com.proofhq.tabletapp).
...
The [!DNL Workfront Proof] appen identifierar automatiskt vilken typ av enhet du använder. Om du vill använda appen på din surfplatta finns mer information i [[!DNL Workfront Proof] mobilapp för surfplattor](../../../workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-app-tablet.md).
...
Om du är [!DNL Workfront Proof] kan du logga in på appen innan du öppnar några korrektur. Med appen kan du bläddra bland alla korrektur som delas med dig och enkelt växla mellan dem.
...
| **E-postlänk** | Om du vill öppna ett korrektur från ditt e-postmeddelande öppnar du bara e-postmeddelandet i ditt e-postprogram och klickar på [!UICONTROL Go to proof] knapplänken i e-postmeddelandet (1) så kommer du till korrekturet i [!DNL Workfront Proof] app. |
...
1. Tryck på **[!UICONTROL Add comment]** knapp (1).
...
1. Gör något av följande:
   ...
   * Gå tillbaka till korrekturbilden genom att trycka på [!UICONTROL callout] -ikon.
   ...
   * Så här utför du en åtgärd på en kommentar:
      ...
      1. Tryck **[!UICONTROL Add action]** (2)
         ...
         Mer information om åtgärder finns i [Använda funktionsmakron för korrekturkommentarer](../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/use-actions-on-comments-in-viewer.md).
...
1. Tryck på ett bevis som du har öppnat **Lägg till kommentar** (1)

   ![tap_the_add_comment_button.png](assets/tap-the-add-comment-button-350x541.png)

1. Välj mellan [!UICONTROL pan mode] (2), [!UICONTROL rectangle tool] (3), [!UICONTROL freehand drawing] eller [!UICONTROL arrow] verktyg (5).
...
1. Navigera genom att trycka på [!UICONTROL navigation] bar (2).
1. Lämna en kommentar genom att trycka på **[!UICONTROL Comment]** och följ sedan instruktionerna ovan.
...
1. Välj ett alternativ genom att trycka på **[!UICONTROL Decision]** (6) och följ sedan instruktionerna ovan.
