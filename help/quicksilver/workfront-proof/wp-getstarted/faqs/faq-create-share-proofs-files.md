...
Om du vill skapa ett korrektur i kontot måste du vara en användare med rätt behörighetsprofil (se [[!UICONTROL Proof Permissions Profiles] in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md)).

Om du överför flera filer samtidigt kan du skapa flera korrektur som du kan skicka till samma grupp med granskare via ett och samma e-postmeddelande. Om din organisation har en [!UICONTROL Enterprise] eller [!UICONTROL Unlimited] kan du kombinera filer till ett enda korrektur (se [Skapa ett korrektur för flera sidor](../../../review-and-approve-work/proofing/creating-proofs-within-workfront/create-multi-page-proof.md)).
...
Du behöver inloggningsuppgifter för att skapa korrektur direkt i en [!DNL Workfront Proof] konto.

## Vad innebär att dela ett bevis?

### Svar

Genom att dela ett korrektur får granskarna tillgång till det så att de kan lägga till kommentarer och markeringar och fatta beslut i det. Gästgranskarna får åtkomst till korrektur från e-postmeddelanden de får. Granskare med egna [!DNL Workfront Proof] kontot har åtkomst till korrektur på [!UICONTROL Dashboard].

## Hur delar jag ett bevis?

### Svar

När du skapar ett korrektur kan du lägga till granskare i [!UICONTROL Workflow] i [!UICONTROL New Proof] sida. När beviset är klart, [!DNL Workfront Proof] skickar ett e-postmeddelande till granskarna med en länk till korrekturet.

Om du har tillräcklig behörighet för ett bevis kan du använda korrekturläsaren, [!UICONTROL Dashboard]eller någon av listvyerna för att lägga till granskare i ett befintligt korrektur (se [Dela ett korrektur i [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof.md) and [Manage Items on the [!UICONTROL Views] Sida in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md).
...
Nej. Gästgranskare (personer utan [!DNL Workfront Proof] inloggningsuppgifter) kan få åtkomst till ett korrektur från det e-postmeddelande om korrektur de får. Du kan dela ett bevis med så många gäster du vill.

Det går att begränsa delning av korrektur till personer med [!DNL Workfront Proof] inloggningsuppgifter. Då läggs ytterligare ett säkerhetsskikt till i korrekturet. För ökad säkerhet bör systemadministratörer i organisationer med [!UICONTROL Enterprise] och [!UICONTROL Unlimited] planer kan konfigurera detta krav för alla korrektur som skapats i organisationen.
...
[!DNL Workfront Proof] -användare kan konvertera filer till korrektur när de har sparat dem på sitt konto.
