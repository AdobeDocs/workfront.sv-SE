...
title: Förstå layouten för tidrapporten
...
# Förstå layouten för tidrapporten
...
Inställningar för tidrapport och timma styr vad som visas på en tidrapport. I den här artikeln finns en översikt över alla tillgängliga alternativ. Mer information finns i [Konfigurera tidrapport och timinställningar](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md).
...
Här följer ett tidrapportområde:
...
* Området Åtgärder som innehåller följande:
   ...
   * Ikonen Mer med alternativet Ta bort där du kan ta bort tidrapporten.
...
* Knappen Lägg till objekt där du kan lägga till projekt, uppgifter eller utgåvor.
...
* Helskärmsikon där du kan visa tidrapporten i helskärmsläge.
* **Öppna sammanfattning** (eller **Stäng sammanfattning**) där du kan öppna eller stänga panelen Sammanfattning för att se ytterligare information om uppgifter eller problem. Detta är inte tillgängligt för projekt.
...
Du kan klicka på knapparna Skicka för godkännande, Stäng, Godkänn och Avvisa i det här området för att stänga eller avvisa ett godkännande av tidrapport.
...
Du kan kommentera i panelen Sammanfattning för uppgifter och utgåvor som visas i en tidrapport. Härifrån kan du kommentera uppgifter och problem eller uppdatera deras information. Mer information finns i [Sammanfattning](../../workfront-basics/the-new-workfront-experience/summary-overview.md).
...
Mer information finns i [Skapa engångstidrapport](../create-and-manage-timesheets/create-tmshts.md) eller [Skapa, redigera och tilldela tidrapportprofiler](../create-and-manage-timesheets/create-timesheet-profiles.md).
