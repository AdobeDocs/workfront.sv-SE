...
title: Dela data med verktyg för affärsinformation och externa datalager
...
# Utbyt data i sjön med verktyg för affärsanalys och externa datalager

Med Workfront datasjön kan ni använda företagets Workfront-data med verktyg för affärsintelligens eller lagra dem på ett externt datalager. Observera att för att du ska kunna använda det valda verktyget måste du lägga till IP-adresserna till tillåtelselista enligt beskrivningen i [Skapa ett läsarkonto](/help/quicksilver/reports-and-dashboards/data-lake/create-a-reader-account.md).
