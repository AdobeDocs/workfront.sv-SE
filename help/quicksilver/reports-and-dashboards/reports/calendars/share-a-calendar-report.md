...
1. I fältet **[!UICONTROL Give Calendar access to]** börjar du skriva namnet på den användare, det team, den roll, den grupp, det företag eller den företagsprofil som du vill dela kalendern med och klickar sedan på namnet när det visas i listrutan.\
