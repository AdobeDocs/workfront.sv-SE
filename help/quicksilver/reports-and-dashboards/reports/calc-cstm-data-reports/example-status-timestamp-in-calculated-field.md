...
# Exempel på beräknat anpassat fält: visa en tidsstämpel för status i ett anpassat formulär
...
1. Klicka **Beräknat** om du vill lägga till ett beräknat anpassat fält i formuläret.
1. Skriv a **Etikett** för det anpassade fältet, till exempel *Anpassat fält för statustidsstämpel*.
1. Klicka **Klar** och sedan klicka **Spara+stäng**.
1. Öppna det anpassade formuläret igen och välj sedan det nya **Anpassat fält för statustidsstämpel** på formuläret.
1. I **Beräkning** kopierar och klistrar in följande beräkning för ditt anpassade fält:
   ...
   >[!NOTE]
   >
   >Beräkningen är identisk för alla objekt och för alla statusvärden. Du måste alltid använda tangenten med tre bokstäver och inte statusnamnet för objektstatusen i den här beräkningen.
   >
   >Mer information om nycklarna för statusvärden finns i [Skapa eller redigera en status](../../../administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/create-or-edit-a-status.md).
