...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[Request, Review, Work, Plan] eller senare</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Produkt</td> 
   <td>[Ange särskild produktinformation. Ta bort den här raden om funktionen är i Workfront-läge]</td> 
  </tr> 
  <tr> 
   <td role="rowheader">Konfigurationer på åtkomstnivå*</td> 
   <td> <p>[Infoga nödvändiga åtkomstnivåkonfigurationer] <!--
  ...
  <tr> 
   ...
   <td> <p>[Infoga nödvändiga behörigheter och ange objektet] <!--
      <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
