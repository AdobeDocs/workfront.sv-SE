...
Din Adobe Workfront-administratör kan ge dig åtkomst att visa eller redigera uppgifter när de tilldelar åtkomstnivåer. Mer information om hur du beviljar åtkomst till uppgifter finns i [Bevilja åtkomst till uppgifter](../../administration-and-setup/add-users/configure-and-grant-access/grant-access-tasks.md).
...
* Du kan dela uppgifter individuellt eller dela flera av dem samtidigt i grupp.\
   Att dela uppgifter är detsamma som att dela andra objekt. Mer information om hur du delar objekt i Workfront finns i [Dela ett objekt](../../workfront-basics/grant-and-request-access-to-objects/share-an-object.md).
