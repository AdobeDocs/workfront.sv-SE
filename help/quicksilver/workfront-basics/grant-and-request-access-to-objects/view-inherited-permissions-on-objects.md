...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Visa eller öka åtkomsten för de objekt som du vill visa behörigheter för</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Objektbehörigheter</td> 
   <td> <p>Visa eller ange högre behörigheter för de objekt som du vill visa behörigheter för</p> </td> 
  </tr> 
 </tbody> 
</table>
