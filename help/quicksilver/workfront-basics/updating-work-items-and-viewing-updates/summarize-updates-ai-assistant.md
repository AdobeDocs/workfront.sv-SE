...
<tr> 
   ...
   <td><p>Visa eller högre behörigheter för de objekt vars uppdateringar du vill visa</p>
   </td>
  </tr>
...
* Din Workfront-administratör måste aktivera AI-assistenten för din organisation.
...
* Din Workfront-administratör måste aktivera AI Assistant för din åtkomstnivå.
...
## Sammanfatta med knappen Sammanfatta kommentarer

1. Gå till objektet vars uppdateringar du vill sammanfatta.
1. Klicka på **Uppdateringar** i den vänstra panelen.
1. Klicka på knappen **Sammanfatta kommentarer** längst upp i området **Uppdateringar**.
