...
description: Genom att få tillgång till [!DNL Workfront] via Adobe CX Enterprise får du en smidig, enhetlig upplevelse när du hanterar alla dina Adobe-program.
author: Courtney
...
[!DNL Workfront] visas i listan över [!DNL Adobe CX Enterprise] produkter som du har tillgång till. Du kan välja [!DNL Workfront] på snabbåtkomstmenyn på startsidan för [!DNL CX Enterprise] eller använda produktväljaren ![produktväljaren](assets/main-menu-icon.png) för att ändra program när som helst.
...
![Profil-menyn](assets/unified-shell-profile-menu-2026.png)
