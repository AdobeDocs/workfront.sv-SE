...
![Övre navigeringsfältet](assets/wf-top-navigation-2026.png)
...
**[!UICONTROL Main Menu]**-ikonen ![Huvudmeny](assets/main-menu-icon-left-nav.png) öppnar [!UICONTROL Main Menu], varifrån du kan navigera till ett annat område i Workfront.
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>[!UICONTROL Boards]: <a href="/help/quicksilver/agile/boards-overview.md">Översikt över anslagstavlor</a></li>
     <li>[!UICONTROL Blueprints]: <a href="/help/quicksilver/administration-and-setup/blueprints/blueprints-overview.md">Översikt över utkast</a></li>
     <li>[!UICONTROL Priorities]: <a href="/help/quicksilver/workfront-basics/priorities/get-started-with-priorities.md">Kom igång med prioriteringar</a></li>
