...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p><strong>En personlig uppgift som jag har tilldelat någon annan har slutförts</strong> </p> <p>Ett meddelande skickas till den användare som tilldelade en personlig arbetsförfrågan till någon annan när begäran är slutförd. </p>  <p>Ämnet för e-postmeddelandet är: <em>Slutförd aktivitet: &lt;Aktivitetsnamn&gt;</em></p> <p> <p>Obs! Du kan inte konfigurera det här meddelandet för ett dagligt sammandrag-e-postmeddelande.</p> </p> </td> 
  ...
  <tr> 
   ...
   <td> <p>Projektnamn (namn på frågekö)<br>Portfolio-namn<br>Ärendereferensnummer<br>Utfärdsnamn<br>Angivet datum<br>Ärendeprioritet<br>Utgåva status<br>Tilldelad till namn<br>Primär kontakt<br>*Projektreferensnummer<br>*Projektnamn<br>*Totalt antal förfrågningar som skickats<br>*Namn på förfrågan<br>*Prioritet<br> 13&rbrace;*Datum för daglig sammandrag</p> </td> 
   <td> <p><strong>Direkt</strong> </p> <p><strong>och Dagligen</strong> </p> </td> 
  </tr> 
  <tr> 
