...
En lista över arbetsuppgifterna och meddelanden som du kan ta emot finns på [Översikt över meddelanden i appen](../../workfront-basics/using-notifications/in-app-notifications-overview.md).
...
>* Meddelanden i appen kan inte anpassas.
>
...
>[!NOTE]
>
>Du kan visa alla meddelanden i appen både från webbprogrammet och mobilprogrammet. Endast vissa av dessa meddelanden skickas som push-meddelanden i mobilprogrammet. Mer information om meddelanden i mobilappen finns i [[!DNL Adobe Workfront] för iOS](../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-ios.md) eller [[!DNL Adobe Workfront] för Android](../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-android.md).
...
1. Klicka på den numrerade ikonen ![](assets/notifications-icon-jewel.jpg) i det övre högra hörnet av [!DNL Workfront] för att öppna din lista över meddelanden.
   ...
   Upp till 80 meddelanden visas i en rullningsbar lista. Om du vill se mer kan du klicka **[!UICONTROL All notifications]** längst ned i listan om du vill visa upp till 100 meddelanden. Meddelanden tas automatiskt bort efter 30 dagar.

   Längst ned i varje meddelande visas [!UICONTROL notification type] och en motsvarande identifieringsikonvisning. De här hjälper dig att identifiera vad som hände med [!DNL Workfront] och meddela dig om du har ett åtgärdsobjekt:

   * Meddelanden visas av [!UICONTROL announcements] ikon. ![](assets/announcement.png)
...
Ikonen till höger om den blå punkten visar något av följande:
   ...
   * Profilfotot för personen som skrev informationen, vanligtvis en uppdatering om en [!DNL Workfront] objekt som du arbetar med.
   * The [!DNL Workfront] logotyp, om meddelandet är ett systemmeddelande.
...
1. Klicka på meddelandet som du vill visa:
   ...
   * Om meddelandet som du klickar på handlar om en arbetsuppgift, är den associerade [!DNL Workfront] objektet öppnas, det fullständiga meddelandet visas på **[!UICONTROL Updates]** -fliken. Du kan **[!UICONTROL Start a new update area]** eller **[!UICONTROL Type a reply]**.

      ![](assets/object-opens-click-work-ntfctn-qs-350x183.png)

   * Om meddelandet du klickar på är för ett meddelande ![](assets/announcement.png), **[!UICONTROL Announcements]** visas med alla meddelanden. Meddelandet som du klickade på markeras till vänster och meddelandet visas till höger.
...
När du har visat meddelanden kan du bekräfta dem för att rensa dem från [!UICONTROL Notifications] eller låta dem svara senare.

På [!UICONTROL Notifications] kan du visa aktuella och rensade meddelanden. Du kan även ta tillbaka rensade meddelanden till [!UICONTROL Notifications] lista.
...
1. Gör något av följande:
   ...
   * Om meddelandet avser ett meddelande klickar du på meddelandet för att öppna meddelandet **[!UICONTROL Announcements]** sida.
   * Klicka **[!UICONTROL All Notifications]** i det nedre högra hörnet av listan över meddelanden som ska visas **[!UICONTROL Notifications]** sida och klicka sedan på **[!UICONTROL Mark all as seen]** i det övre högra hörnet av Workfront.
...
1. Klicka på den numrerade ikonen ![](assets/notifications-icon-jewel.jpg) i det övre högra hörnet av [!DNL Workfront] för att öppna din lista över meddelanden.
1. Klicka **[!UICONTROL All Notifications]** i det nedre högra hörnet av din lista över meddelanden.
1. På **[!UICONTROL Notifications]** sida som visas rullar du nedåt för att visa tidigare meddelanden.
...
Du kan dock ta bort ett meddelande. Du kan även komma åt ett meddelande som du har tagit bort inom 30 dagar efter att du tagit bort det. [!DNL Workfront] meddelanden tas inte bort automatiskt i .
...
1. Klicka på den numrerade ikonen ![](assets/notifications-icon-jewel.jpg) i det övre högra hörnet av [!DNL Workfront] för att öppna din lista över meddelanden.
1. Klicka **[!UICONTROL Announcements]** eller **[!UICONTROL View All Announcements]**.

1. På **[!DNL Announcements]** som visas klickar du på det meddelande du vill ta bort i listan till vänster och klickar sedan på **[!UICONTROL Delete]** i det övre högra hörnet på sidan.
...
1. I **[!UICONTROL Announcements]** sida som visas klickar du på **[!UICONTROL Deleted]**.
