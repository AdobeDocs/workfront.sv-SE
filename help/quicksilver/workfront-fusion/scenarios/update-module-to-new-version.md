...
![Ikonen Uppdatera](assets/update-indicator.png)

Du kan uppdatera modulen utan att skapa ett nytt scenario.

1. Klicka på **Uppgraderingsmodul** icon ![Uppgraderingsikon](assets/upgrade-icon.png) i modulen du vill uppgradera till en ny version.
1. Klicka **Visa nya moduler**.
