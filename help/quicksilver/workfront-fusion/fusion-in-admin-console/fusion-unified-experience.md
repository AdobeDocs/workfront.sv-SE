...
# [!DNL Adobe Unified Experience] för [!DNL Workfront Fusion]
...
>
>* [Ändra profilinställningar](https://experienceleague.adobe.com/docs/workfront-fusion/using/get-started-with-fusion/navigate-workfront-fusion/change-profile-settings.html)
...
Om du får åtkomst till [!DNL Workfront Fusion] via [!DNL Adobe Experience Cloud] får du en smidig, enhetlig upplevelse för att hantera alla dina [!DNL Adobe]-program. Med en identitetshantering kan du logga in på ett och samma ställe, utan flera URL:er eller inloggnings-ID:n.

En videofilm som beskriver navigering i [!DNL Fusion] i [!DNL Adobe Experience Cloud] finns på:
...
1. Skriv din e-postadress på inloggningsskärmen och klicka på **[!UICONTROL Continue]**.

   ![Logga in på [!DNL Adobe Experience Cloud]](assets/aec-login-page.png)

## Åtkomst [!DNL Workfront Fusion]

När du har loggat in på [!DNL Adobe Experience Cloud] kan du visa alla [!DNL Workfront Fusion]-organisationer och miljöer som du har tillgång till genom att klicka på organisationsväljaren i det övre navigeringsområdet. Välj den [!DNL Workfront Fusion]-organisation eller miljö som du vill arbeta i.
...
[!DNL Workfront Fusion] visas i listan över [!DNL Adobe Experience Cloud] produkter som du har tillgång till. Du kan välja [!DNL Workfront Fusion] på snabbåtkomstmenyn på startsidan för [!DNL Experience Cloud] eller använda produktväljaren ![produktväljaren](assets/main-menu-icon.png) för att ändra program när som helst.

![Välj [!DNL Workfront Fusion] för att komma åt programmet](assets/aec-product-switcher.png)

## Navigera [!DNL Workfront Fusion]

Använd ikonen [!UICONTROL Main Menu] ![](assets/main-menu-icon-left-nav.png) till vänster om navigeringsfältet [!DNL Adobe] för att öppna menyerna [!UICONTROL Organization] och [!UICONTROL Team]. Om du är [!DNL Workfront Fusion]-administratör visas även [!UICONTROL Administration]-menyn här.
...
* Få åtkomst till din **[!UICONTROL [!DNL Workfront Fusion] Profile]**. När du är med i profilen klickar du på **[!UICONTROL More]**-menyn ![](assets/more-icon.png) och väljer **[!UICONTROL Edit]**. Mer information om profilen finns i [Konfigurera mina inställningar](/help/quicksilver/workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/configure-my-settings.md).
...
* **Varningar** refererar till fastsatta scenarier.
* **Uppdateringar av innehåll** refererar till fel och varningar i scenariekörningar.
