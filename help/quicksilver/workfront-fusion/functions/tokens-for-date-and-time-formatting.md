...
title: Token för datum- och tidsformatering i [!DNL Adobe Workfront Fusion]
description: Följande variabler för datum- och tidsformatering finns i [!DNL Adobe Workfront Fusion mapping] -panelen.
author: Becky
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Unix millisekundstämplar</p> </td> 
  </tr> 
 </tbody> 
</table>
