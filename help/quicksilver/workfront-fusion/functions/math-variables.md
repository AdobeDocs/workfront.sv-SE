...
description: Följande matematiska variabler är tillgängliga i [!DNL Adobe Workfront Fusion mapping] -panelen.
author: Becky
...
Använd följande formel för att generera ett pseudoslumpmässigt heltal i intervallet [`min`,`max`] (inklusive båda `min` och `max`):
