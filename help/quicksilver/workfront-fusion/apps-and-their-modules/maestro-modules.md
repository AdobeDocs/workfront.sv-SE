...
title: Adobe Maestro-moduler
description: Med [!DNL Adobe Maestro] -moduler kan du starta en [!DNL Adobe Workfront Fusion] scenario baserat på händelser i [!DNL Adobe] Makrokonto, skapa, läsa eller uppdatera avtal och andra poster, söka efter poster med villkor som du anger och ladda upp dokument.
author: Becky
...
# [!DNL Adobe Maestro] moduler

Med [!DNL Adobe Maestro] -moduler kan du utlösa ett scenario när händelser inträffar i Maestro. Du kan också skapa, läsa, uppdatera och ta bort poster eller utföra ett anpassat API-anrop till [!DNL Adobe Maestro] konto.
...
## Skapa en anslutning till [!DNL Adobe Maestro]

Du kan skapa en anslutning till [!DNL Maestro] direkt inifrån ett [!DNL Workfront Fusion] -modul.

1. I alla [!DNL Maestro] programmodul, klicka på **[!UICONTROL Add]** bredvid [!UICONTROL Connection] box.
...
## [!DNL Adobe Maestro] moduler och deras fält

### Se händelser

Den här utlösarmodulen startar ett scenario när en post, posttyp eller arbetsyta skapas, uppdateras eller tas bort i Maestro.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Instruktioner om hur du skapar en anslutning till [!DNL Adobe Maestro], se <a href="#create-a-connection-to-adobe-maestro" class="MCXref xref" >Skapa en anslutning till [!DNL Adobe Maestro]</a> i den här artikeln.</td>
    </tr>
    <tr>
...
Den här åtgärdsmodulen tar bort en enskild posttyp i Maestro med dess ID.

>[!WARNING]
>
>Om du tar bort en posttyp i Maestro tas även alla poster i posttyptabellen bort.
...
Den här modulen gör ett anpassat API-anrop till [!DNL Adobe Maestro] API.
...
Den här åtgärden skapar en enda post i Maestro.
  ...
  <tbody>
    <tr>
     ...
     <tr>
      ...
      <td>Ange eller mappa den typ av post som du vill skapa. Tillgängliga posttyper baseras på ditt Maestro-konto.</td> 
      </tr>
     <tr>
      <td role="rowheader">
        <p>Andra fält</p>
...
Den här åtgärdsmodulen tar bort den angivna posten i Maestro.
...
Den här åtgärdsmodulen hämtar en post från [!DNL Adobe Maestro], som anges av dess ID.
...
Den här åtgärdsmodulen hämtar en lista med posttyper i en [!DNL Adobe Maestro] konto.
...
Den här åtgärden uppdaterar en enda post i Maestro.
  ...
  <tbody>
    <tr>
     ...
     <tr>
      ...
      <td>Ange eller mappa den typ av post som du vill uppdatera. Tillgängliga posttyper baseras på ditt Maestro-konto.</td> 
      </tr>
     <tr>
      <td role="rowheader">
        <p>Andra fält</p>
