...
description: Du kan använda  [!DNL Adobe Workfront Fusion] för att ansluta till [!DNL Google Services] med en anpassad OAuth-klient. Den här proceduren kräver ett befintligt [!DNL Google] konto.
author: Becky
