...
title: Använd en [!DNL Anaplan] budgetallokering till en [!DNL Adobe Workfront] projekt
...
# Använd en [!DNL Anaplan] budgetallokering till en [!DNL Adobe Workfront] projekt

Det här integreringsscenariot synkroniserar alla budgetallokeringar som har gjorts i [!DNL Anaplan] tillbaka till [!DNL Workfront]. Scenariot hämtar alla länkade kampanjbudgetartiklar och skickar sedan det budgade värdet till den länkade [!DNL Workfront] projekt om budgetvärdet har ändrats.
...
* En användarprofil i [!DNL Workfront] namngiven **Integrering med Anaplan**, som har systemadministratörsbehörighet.
...
* En användarprofil i [!DNL Anaplan] namngiven **[!DNL Workfront]Integrering**, som har systemadministratörsbehörighet.
...
* En vy i [!DNL Anaplan] namngiven **[!UICONTROL Campaigns.Update Campaigns in Adobe Workfront]**.
   ...
   6. [!UICONTROL Brand]
   Vyn ska filtreras så att objekt som har en [!UICONTROL [!DNL Workfront] Project GUID] och en indikator på att budgetallokeringar ska överföras till [!DNL Workfront].
...
1. Navigera till [!UICONTROL Templates] menyn i [!DNL Workfront Fusion] och klicka på **[!UICONTROL Apply [!DNL Anaplan] budget allocations to Workfront projects]** scenariomall.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>Namnet på modulen som beskriver kampanjattributen i det valda [!DNL Anaplan] Lista.</td> 
     </tr> 
     <tr> 
