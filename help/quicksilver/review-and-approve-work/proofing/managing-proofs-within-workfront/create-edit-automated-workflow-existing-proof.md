...
Mer information om hur du skapar ett automatiskt arbetsflöde för ett nytt korrektur finns i [Skapa ett avancerat korrektur med ett automatiserat arbetsflöde](../../../review-and-approve-work/proofing/creating-proofs-within-workfront/create-automated-proof-workflow.md).
...
1. Håll muspekaren över dokumentet i området Dokument och klicka sedan på Arbetsflöde för korrektur.
   ...
   Om du granskar korrekturet i korrekturläsaren klickar du på **Arbetsflöde** ![](assets/workflow-icon-proofing-viewer.png) i den vänstra panelen och klicka sedan på ikonen Redigera ![](assets/edit-icon-proofing-viewer.png) för att öppna inställningarna för automatiserat arbetsflöde för korrekturet.
...
1. (Villkorligt) Om du vill använda en mall för automatiserat arbetsflöde som din Adobe Workfront-administratör har skapat och delat med dig klickar du på **Lägg till mall** markerar du mallen i rutan som visas och klickar sedan på **Lägg till mall**.
...
1. Lägg till en scen i det automatiserade arbetsflödet:
   ...
   1. Klicka **Ny fas** nära det övre högra hörnet.
   1. I rutan som visas skriver du **Namn** för scenen.
   1. (Valfritt) Ange en deadline för scenen.
   1. I **Aktivera fas** väljer du hur du vill att scenen ska aktiveras:
      ...
      <td>Klicka på föregående scen i <strong>Överordnad fas</strong> nedrullningsbar lista .</td>
      </tr>
      <tr>
      <td><strong>På ett visst datum och en viss tid</strong></td>
      <td>Klicka på <strong>På</strong> markerar du datumet och klickar sedan i rutan till höger för att välja tidpunkten.</td>
      </tr>
      <tr>
      <td><strong>Alla beslut godkänns eller godkänns med ändringar på den överordnade fasen</strong></td>
      <td>Klicka på den överordnade scenen i <strong>Överordnad fas</strong> nedrullningsbar lista.</td>
      </tr>
      <tr>
   ...
   1. Ange ett kontaktnamn eller en e-postadress och konfigurera inställningar för granskarna för scenen.
      ...
      Mer information om hur du lägger till granskare finns i [Lägga till granskare på en scen](#about-adding-reviewers-to-a-stage) i den här artikeln.
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>Tillåter endast följande personer att visa kommentarer och beslut som fattats under den här fasen: Administratörer, Adobe Workfront-administratörer och Workfront korrekturadministratörer</td>
        </tr>
        <tr>
...
* Du kan dra en eller flera användare från en scen till en annan. Du kan dra användare direkt till en annan scen eller dra användare till en scen på **Steg** diagram. Om du vill markera flera användare trycker du på Skift+Ctrl (Windows) eller Skift+Kommando (Mac).
...
* Om du lägger till en användare på en scen får användaren som standard åtkomst till korrekturet från det att korrekturet skapas.
   ...
   Din Workfront-administratör kan hindra användare från att komma åt korrekturet tills arbetsflödet går in på den scen där användaren lades till. Mer information finns i .
