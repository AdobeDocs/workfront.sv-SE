...
title: Redigera fältet Behörighetsprofil för korrektur i grupp
...
# Redigera fältet Behörighetsprofil för korrektur i grupp
...
1. Sortera användarna efter **Åtkomstnivå**. Vi rekommenderar batchredigering på åtkomstnivå för att säkerställa **Behörighetsprofil för korrektur** visas.
...
1. Klicka **Redigera** högst upp i listan.
1. I **Åtkomst** -avsnittet finns i **Behörighetsprofil för korrektur** och gör ditt val.

   >[!NOTE]
   >
   >Beroende på din Workfront-plan kan du behöva aktivera **Användaren kan skapa korrektur** kryssruta för **Behörighetsprofil för korrektur** visas.
