...
title: Kom igång med granskning och godkännande av resurser
...
# Kom igång med granskning och godkännande av resurser
...
>[!IMPORTANT]
>
>Den här funktionen kommer snart. För närvarande läggs Frame.io-konton till manuellt av Workfront-teamet. Kontakta din kontorepresentant på Adobe.
...
* **Granskare** kan lägga till kommentarer och kommentera resurser. När de är klara kan de markera granskningen som slutförd. Att markera granskningen som slutförd krävs inte för att resursen ska gå framåt i godkännandeprocessen.<!--example of when to add reviewers-->
...
* **Godkännandemallar**: Under Konfigurera i Workfront kan projektsamordnare skapa återanvändbara mallar för godkännande. I en mall kan användare lägga till granskare och godkännare och ange en tidsram för slutförande. När godkännandemallen används för en resurs beräknas tidsgränsen från den angivna tidsramen.
  ...
  Mer information finns i [Skapa och hantera godkännandemallar]
  <!--add link.-->

* Överför en resurs från Workfront och skicka den till en bildruta för granskning och godkännande <!-- delayed? -Need more info on this workflow -->

### Godkänn resurser i Frame.io

Intressenter kan granska och godkänna anslutna resurser med Frame.io-visningsprogrammet.

Mer information om hur du granskar resurser i Frame.io finns i <!-- get link from frame team?-->
...
Granskarna kan markera sin granskning som komplett inuti Frame.io-visningsprogrammet, men detta krävs inte för att resursen ska gå framåt i godkännandeprocessen. <!--check if this is accurate -->
...
### Skicka godkända mediefiler till Adobe Experience Manager Assets

<!-- deprioritized?-->
Använd den inbyggda integreringen för att skicka godkända mediefiler till Adobe Experience Manager Assets.
...
![](assets/example-workflow.png) - behöver förmodligen en annan version av den här videon eller till och med en genomgång av videon
