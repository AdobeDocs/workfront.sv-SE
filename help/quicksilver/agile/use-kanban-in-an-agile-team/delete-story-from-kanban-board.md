...
# Ta bort artiklar eller utgåvor från [!UICONTROL Kanban] board

Du kan ta bort en artikel eller ett problem från [!UICONTROL Kanban] bräda. När du tar bort en artikel eller ett problem flyttas den till papperskorgen i 30 dagar och kan endast återställas av systemadministratören.
...
1. Klicka på **[!UICONTROL More]** ikon på artikeln eller utgåvan och välj **[!UICONTROL Delete]**.
