...
[!DNL Adobe Workfront] har flera verktyg som hjälper dig att definiera Agile-arbetsflöden. Styrelserna är enkla men ändå flexibla verktyg för teamsamarbete. De äldre Agile-planeringsverktygen innehåller en eftersläpning och en artikelpanel för Kanban- eller Scrum-team.
...
* [Använd Agile-planeringsverktygen i ritytorna](/help/quicksilver/agile/use-boards-agile-planning-tools/agile-planning-tools-overview.md)
* [Agile - översikt](../agile/agile-overview.md)
* [Kom igång med Agile i [!DNL Adobe Workfront]](../agile/get-started-with-agile-in-workfront/get-started-with-agile.md)
