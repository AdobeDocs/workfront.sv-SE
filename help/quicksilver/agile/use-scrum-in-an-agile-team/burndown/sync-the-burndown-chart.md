...
# Synkronisera data i nedladdningsbart diagram

Nedladdningsschemat synkroniseras automatiskt med data i ditt projekt eller din iteration. Om nedladdningsdiagrammet någonsin blir osynkroniserat med data i projektet eller iterationen kan du synkronisera det manuellt.
...
1. Gå till den iteration där du vill synkronisera nedladdningsdiagrammet manuellt.
1. Klicka på synkroniseringsikonen ![Synkroniseringsikonen](assets/agile-syncicon.png) bredvid iterationsnamnet.
