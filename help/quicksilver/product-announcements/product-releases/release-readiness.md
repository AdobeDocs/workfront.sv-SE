...
* [Utforska miljön [!UICONTROL Preview Sandbox]](#explore-the-preview-sandbox-environment)
...
Versionsinformation för en viss funktion publiceras när funktionen går till din [!UICONTROL Preview Sandbox]-miljö. På så sätt kan du ta reda på och utforska funktionen innan den ingår i produktionsmiljön.
...
>[!IMPORTANT]
>
>Meddelanden från meddelandecentret direkt från [!DNL Workfront] är bara tillgängliga för [!DNL Workfront] administratörer.

Som administratör för [!DNL Workfront] får du ett meddelande från [!DNL Workfront] om olika aspekter av releasen. Du får ett meddelande från meddelandecentret när något av följande inträffar:
...
När en funktion släpps i sandlådemiljön för förhandsgranskning, uppdateras [!DNL Workfront]-dokumentationen med den nya funktionen. Du kan söka efter den tillämpliga artikeln eller följa länkar till dokumentationen från versionsinformationen.
...
* Meddelanden om samarbetsverktyg, som [!DNL Slack] eller [!DNL Microsoft Teams]
