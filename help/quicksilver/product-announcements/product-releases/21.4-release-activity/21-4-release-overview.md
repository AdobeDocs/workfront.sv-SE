...
For specific release dates and times for each cluster, see the [Adobe Workfront status page](https://status.adobe.com/sv-se/products/5943) on [status.adobe.com](http://status.adobe.com/sv-se/). You must log in to see specific release times.
