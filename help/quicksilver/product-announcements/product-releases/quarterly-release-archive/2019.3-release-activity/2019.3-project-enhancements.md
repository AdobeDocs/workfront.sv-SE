...
Nu kan du redigera Gantt-schemat för uppgiftslistan när Spara automatiskt är aktiverat eller inte. Du kan inte ångra ändringar när växlingsknappen är aktiverad. I det här fallet sparas de ändringar du gör i projektet automatiskt.
...
Flikarna Dokument och problem tas bort från sidan Agile-information:
...
Mer information finns i Meddelanden: Information om projekt som jag är med i.
...
## Synlighet i tidsgränsschemat för en användare när de tilldelas uppgifter och problem
...
Mer information om ledig tid finns i [Konfigurera ledig tid i Adobe Workfront](../../../../workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/personal-time-overview.md).
...
Tillgänglighet för förhandsgranskning: 30 maj 2019
Produktionstillgänglighet: 13 juni 2019
Före produktionsreleasedatum stöds inte de nya anpassade fälten i Mobile, Outlook, MS Teams och den inbyggda Salesforce-integreringen.
I Production stöds nu Outlook och MS Teams. Mobilt stöds från slutet av juni eller början av juli. Salesforce-integreringar stöds från juni.
