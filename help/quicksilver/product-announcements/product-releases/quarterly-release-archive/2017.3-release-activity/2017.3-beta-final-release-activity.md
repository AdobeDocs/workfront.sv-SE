...
* [Förbättrade korrekturfunktioner i Workfront](#proofing-enhancements-within-workfront)
...
* [Ny gruppering för resursbudgeterade timrapporter: Fördelningsdatum](#new-grouping-for-resource-budgeted-hour-reports-allocation-date)
...
>[!NOTE]
Denna funktionalitet kommer inte att lanseras i produktionsmiljön i version 17.3. det kommer att finnas kvar i förhandsgranskningen fram till början av 2018.
...
HTML5-visningsprogrammet stöder ännu inte alla funktioner som finns i det befintliga visningsprogrammet för Flash. Följande funktioner är inte tillgängliga för närvarande, men kommer att ingå i en framtida version:
...
* [Resursplanering: Visa data efter vecka och kvartal](#resource-planner-show-data-by-week-and-quarter)
...
* Tilldela uppgifter och ärenden från en länk som delas med dig till dem
* Godkänn ditt arbete
...
* Lägg till en uppgift eller ett problem i ett projekt i Workfront: Med tillägget Outlook 365 kan du nu konvertera ett e-postmeddelande till en uppgift eller ett problem i Workfront. I den här processen kan du ange ett projekt som du vill att uppgiften eller utgåvan ska läggas till i, samt en tilldelad och ett förfallodatum. Före den här förbättringen kunde du bara skicka en begäran till en begärandekö eller lägga till en personlig uppgift i listan Arbeta på från Outlook 365. 
* Bevara en länk till Workfront-objekt i det ursprungliga e-postmeddelandet som konverterats till uppgifter, ärenden eller förfrågningar: När du konverterar ett e-postmeddelande från Outlook 365 till en uppgift, ett problem eller en begäran, bevarar Outlook 365 en länk till uppgiften eller problemet som konverterades från det e-postmeddelandet i det ursprungliga e-postmeddelandet. Före den här ändringen fanns det ingen indikation i Outlook om ett e-postmeddelande har konverterats till en uppgift eller skickats som en begäran. 
