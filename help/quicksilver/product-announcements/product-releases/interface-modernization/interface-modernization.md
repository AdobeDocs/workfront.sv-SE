---
title: Modernisering av gränssnitt
...
**Förhandsversion: 23 oktober 2025; Produktionsversion: Från 6 november 2025**
...
Vi har uppdaterat rutan Redigera problem när vi redigerar enstaka utgåvor eller redigerar flera.
...
Mer information finns i [Redigera problem](/help/quicksilver/manage-work/issues/manage-issues/edit-issues.md).
...
Vi har uppdaterat utseendet på rutorna Ny och Redigera timtyp när vi lägger till eller redigerar timtyper i området Timtyper i installationsprogrammet. Området Timtyper visas under Timesheet &amp; Timours under Inställningar. Nu matchar rutorna Ny och Redigera timtyp andra områden i Workfront.
...
Exportknappen har flyttats till höger på sidan.
...
**Förhandsversion: 2 oktober 2025; Produktionsversion: Från 6 oktober 2025**
...
Vi har uppdaterat dialogrutan för att lägga till en ny utgift i ett projekt, så att den matchar andra delar av programmet. Den uppdaterade dialogrutan är tillgänglig när du lägger till utgifter i projekt eller mallar.
...
Vi har uppdaterat utseendet och känslan i följande listor över mallar:
...
Uppdateringen innehåller visuella ändringar i listan över layoutmallar. Ingen funktionalitet har ändrats.

Om du vill visa ändringen går du till Inställningar > Gränssnitt > Layoutmallar.
...
**Förhandsversion: 26 juni 2025; Produktionsversion: 10 juli 2025**

Vi har uppdaterat företagssidan med en modernare design som överensstämmer med andra delar av Workfront.

Uppdateringen innehåller visuella ändringar av listan över företag. Ingen funktionalitet har ändrats.

Om du vill se ändringen går du till Inställningar > Företag.

Mer information finns i [Skapa och redigera företag](/help/quicksilver/administration-and-setup/set-up-workfront/organizational-setup/create-and-edit-companies.md).


### Uppdatera till listan Åtkomstnivåer i installationsprogrammet

**Förhandsversion: 19 juni 2025; Produktionsversion: 23 juni 2025**

Vi har uppdaterat åtkomstnivålistan i Setup med en modernare design som är konsekvent med andra delar av Workfront.

Om du vill visa den här ändringen går du till Inställningar > Åtkomstnivåer.
...
Vi har uppdaterat sidan Importera data (Spark-Starts) i inställningsområdet med en modernare design som överensstämmer med andra delar av Workfront. Snabbstartsprocessen förenklades också så att den markerade filen laddas upp direkt. Du behöver inte längre klicka på en separat **Överför**-knapp för att slutföra importen när du har valt filen.

Mer information finns i [Importera data till Workfront med en snabbstartmall](/help/quicksilver/administration-and-setup/manage-workfront/using-kick-starts/import-data-via-kickstarts.md).

### Gränssnittsuppdateringar i listan Utgiftstyper

**Förhandsversion: 22 maj 2025; Produktionsrelease för alla kunder: 29 maj 2025**

Vi har uppdaterat utseendet och känslan i listan över utgiftstyper under Konfigurera, så att den matchar designen i andra delar av Workfront.

En liten funktionsändring har gjorts i listan Utgiftstyper. Om du vill redigera eller ta bort en utgiftstyp markerar du den i listan och klickar på lämplig ikon. Observera att du inte kan redigera eller ta bort standardutgiftstyperna.
...
Vi har uppdaterat delningsdialogrutan så att användare kan dela dokument med externa användare via en e-postadress. Den här funktionen var inte tillgänglig för tillfället på grund av gränssnittets modernisering.

+++

### Navigering och sökning

+++Expandera för att visa de uppdateringar av navigerings- och sökgränssnittet som gjorts i Q3
...
### Utseendeförändringar i rutorna Ny ämnesgrupp och Redigera ämnesgrupp i ett projekt

**Förhandsversion: 26 juni 2025; Produktionsversion: 10 juli 2025**

Vi har uppdaterat utseendet och känslan av upplevelsen när vi skapar eller redigerar ämnesgrupper för frågeköer, så att de matchar andra områden i Workfront.

Den nya upplevelsen är tillgänglig när du skapar eller redigerar ämnesgrupper i projekt eller mallar.
...
Förhandsversion: 19 juni 2025; Produktionsrelease: 26 juni 2025

Vi har uppdaterat utseendet och känslan i utgiftsrapporten så att den matchar designen i andra delar av Workfront.
...
**Förhandsversion: 26 juni 2025; Produktionsrelease för alla kunder: 10 juli 2025**

Vi har uppdaterat utseendet på organisationsschemat som är kopplat till en Workfront-användare så att det matchar designen i andra delar av Workfront.

Om du vill visa den här ändringen går du till en Workfront-användarprofil och klickar på **Organisationsschema** i den vänstra panelen. (Den här funktionen är tillgänglig via Workfront användarprofil, inte Adobe användarprofil.)

Mer information finns i [Visa organisationsschemat](/help/quicksilver/people-teams-and-groups/work-directly-with-others/view-the-org-chart.md).
...
### Gränssnittsuppdatering för anpassning av händelsemeddelandeämnen
...
Om du vill visa den här sidan går du till Inställningar > E-post > Meddelanden > E-postmallar.
...
Vi har uppdaterat redigeringsdialogrutan för smarta mappar med en modernare design som är konsekvent med andra delar av Workfront.
