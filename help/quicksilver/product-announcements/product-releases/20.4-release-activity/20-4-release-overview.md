...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 15 oktober 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 8 oktober 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 8 oktober 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 25 september 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 29 augusti 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 21 augusti 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 11 september 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaförhandsversion: 15 oktober 2020 (export av översiktsområdet lades till 3 november 2020)</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 15 oktober 2020</p> <p>Produktionsrelease: Med version 20.4 <span style="color: #dc143c; font-weight: bold;">Tillfälligt otillgänglig</span></p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 23 oktober 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 25 september 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p><strong>Tillgängligt på följande datum:</strong> </p> <p>Betaversion: 20 augusti 2020</p> <p>Produktionsversion: 8 oktober 2020</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 21 augusti 2020</p> <p>Produktionsrelease: 17 september 2020</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 8 oktober 2020</p> <p>Produktionsrelease: Med version 20.4 <span class="uitext" style="color: #dc143c;">(Uppskjuten till mars 2021)</span></p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.4-release-activity/20-4-proof-enhancements.md#auto-gen" class="MCXref xref" xrefformat="{para}">Generera ett korrektur automatiskt när du överför en dokumentinställning inaktiverat som standard</a> </p> <p>Alternativet i användarprofilen att automatiskt generera korrektur när dokument överförs är nu inaktiverat som standard för nya korrekturanvändare. Den här ändringen påverkar inte aktuella användare. Om du har aktiverat den här inställningen kommer den att vara så stor.</p> <p>Tidigare var den här inställningen aktiverad för nya användare som standard.</p> </td> 
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 18 september 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 9 september 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: TBD</p> <p>Produktionsrelease: Med version 20.4 <strong>(Uppskjuten till december 2020 eller början av 2021)</strong></p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.4-release-activity/20-4-mobile-enhancements.md#get" class="MCXref xref" xrefformat="{para}">Få hjälp med Workfront mobiles Virtual Assist-kommandon</a> </p> <p>I mobilappen kan du be den virtuella assistenten att hjälpa dig med kommandon genom att säga Vad kan jag göra?" en"Hjälp mig med kommandon".</p> <p>Dessa kommandon visar en lista med de olika saker du kan fråga assistenten om.</p> </td> 
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: Ej tillämpligt</p> <p>Produktionsrelease: Med version 20.4 </p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 20 oktober 2020</p> <p>Produktionsrelease: Med version 20.4</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Tillgängligt på följande datum:</strong> <p>Betaversion: 11 september 2020</p> <p>Produktionsrelease: Med version 20.4 till produktion</p> <p><strong>Finns i följande miljöer:</strong> </p> <p>Nya Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Workfront vill hjälpa er att gå över till den nyare tekniken genom att tillhandahålla en serie nya lösningar som inte är beroende av Flash. Läs mer om ersättningslösningar för respektive verktyg i följande Flash: [Ersättning av verktyg baserade på Flash i Adobe Workfront](../../../product-announcements/announcements/announcement-archive/replace-flash-tools.md).
