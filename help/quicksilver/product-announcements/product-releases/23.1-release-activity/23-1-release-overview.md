...
Webbseminariet 23.1 hölls tisdagen den 10 januari 2023. Du kan [registrera dig för webbinariet om du vill visa en inspelning på begäran här](https://event.on24.com/wcc/r/3995983/A5FC731C36313CE081AEBB3B1AA39C77).

<span class="preview">Funktioner utanför cykeln (de som släpps till produktion före 23.1-releasedatum) är markerade i gult.</span>
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-project-enhancements.md" class="MCXref xref" xrefformat="{para}">Sekundära jobbroller har lagts till i listan Andra tilldelningar när objekt tilldelas gruppvis i arbetsbelastningsutjämnaren</a></p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Förfallodatum på kort mappas till planerat slutförandedatum på Workfront-objekt</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Poster i checklistan för anslagstavlor och Workfront-underaktiviteter är nu länkade</a></p>
                    ...
                    <td><p><b>Tillgängligt på följande datum:</b></p>
                     <p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Produktionsrelease för tidig anmälan: 1 december 2022 <span style="color: #ff0000;"> Den här funktionen är endast tillgänglig i Produktion på detta datum genom tidig anmälan av funktioner för Workfront Boards.</span></p>
                                <p>Produktionsrelease för alla kunder: Med version 23.1</p>
                            </li>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td><p><b>Tillgängligt på följande datum:</b></p>
                     <p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Produktionsrelease för tidig anmälan: 17 november 2022 <span style="color: #ff0000;"> Den här funktionen är endast tillgänglig i Produktion på detta datum genom tidig anmälan av funktioner för Workfront Boards.</span></p>
                                <p>Produktionsrelease för alla kunder: Med version 23.1</p>
                            </li>
                        </ul>
                    </td>
                    ...
                    <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Länkbara kort är nu tillgängliga på ritytor</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Filtrera efter anslutning på ritytor</a></p>
                    ...
                    <td><p><b>Tillgängligt på följande datum:</b></p>
                     <p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Produktionsrelease för tidig anmälan: 3 november 2022 <span style="color: #ff0000;"> Den här funktionen är endast tillgänglig i Produktion på detta datum genom tidig anmälan av funktioner för Workfront Boards.</span></p>
                                <p>Produktionsrelease för alla kunder: Med version 23.1</p>
                            </li>
                        </ul>
                    </td>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-mobile-enhancements.md" class="MCXref xref" xrefformat="{para}">Poängen finns nu i mobilappen</a><span style="color: #ff0000;"> Kommer snart!</span></p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Förbättrad filterupplevelse är vanligtvis tillgänglig i Adobe Workfront</a></p>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Ny funktion för listkontroll på sidorna Filter, Vyer och Grupperingar i inställningsområdet.</a></p>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-look-and-feel-updates.md" class="MCXref xref" xrefformat="{para}">Uppdateringar av utseende och känsla under tidsramen för version 23.1</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Byt namn på häftstift och en ny upplevelse när du tar bort häftstift</a></p>
...
Nya funktioner i Workfront Fusion finns i Production vid en senare tidpunkt än 23.1. Mer information om de senaste funktionerna finns i [Adobe Workfront Fusion-versionsaktivitet](/help/quicksilver/product-announcements/product-releases/fusion-release-activity/fusion-release-activity.md).
...
Nya funktioner i Workfront Goals-versionen med version 23.1. Mer information om de här nya funktionerna som nu finns i Förhandsgranska finns i [Adobe Workfront-mål i version 23.1](/help/quicksilver/product-announcements/product-releases/goals-release-activity/goals-23-1-release/goals-23-1-release.md).
...
Information om nyheter och uppdateringar finns i [Nyheter i API-version 15](/help/quicksilver/wf-api/api/new-api-version-15.md).
...
#### **Borttagning och borttagning av kampanjområdet (Beta) från förhandsvisningsmiljön**
...
* Ta bort området Campaigns (Beta) från huvudmenyn och från Layoutmallar i produktionsmiljön för de kunder som aktiverat det på begäran.

Dessutom tas alla artiklar som beskriver den här funktionen också bort.

#### **Listkontroller (från gränssnittsområdet i installationsprogrammet)**

Listkontroller i Inställningar > Gränssnitt tas bort i version 23.1.
...
#### **SHARE-händelsetypen i API:t för händelseprenumerationer.**
