...
>[!NOTE]
>
>Händelseprenumerationer använder TLS version 1.3 om servern som händelseteckningen skickar händelser som stöder version 1.3. Om anslutningsservern inte stöder version 1.3 används TLS version 1.2 för händelsetjänsten.
...
| Förhandsgranskning | *.preview.eventsubscriptions.workfront.com | subject= /C=US/ST=Utah/L=Lehi/O=Workfront, Inc./CN=*.preview.eventsubscriptions.workfront.com |
...
* [Klientcertifikat - produktionsmiljö](assets/prod-ES-client-cert-oct25.crt)
* [Klientcertifikat - förhandsvisningsmiljö](assets/preview-ES-client-cert-oct25.crt)
* [Klientcertifikat - sandlådemiljö](assets/sandbox-ES-client-cert-oct25.crt)
