...
Det vanligaste hindret för en framgångsrik utrullning är inte teknik. Det är&quot;teknikfel&quot;. När team stöter på utmaningen att arbeta med nya medarbetare, nya processer och nya verktyg samtidigt blir verktyget ett mål för frustration.
...
Så här aktiverar du den här utvecklingsändringen:

1. Välj ett pilotteam som är redo och villigt att finna nya vägar.
2. Använd de första 15 dagarna av lanseringen för att bevisa att modellen fungerar på ett av två kraftfulla vägar:

   * **Den parallella sökvägen (eller en dubbelspårningsmetod):** Teamet underhåller det aktuella arbetsflödet samtidigt som nästa planeringscykel modelleras i Workfront Planning.

     Detta skapar muskelminne och självförtroende utan risk för en enda felpunkt.

   * **Den rena brytningen:** Efter en inledande designövning där exempeldata används för att validera modellen flyttar teamet sin livestartpunkt direkt till Workfront Planning för nästa cykel.
...
Vi rekommenderar att du hela tiden letar efter framgångsmarkörer och justerar utifrån dina resultat.
