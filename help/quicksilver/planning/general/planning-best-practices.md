...
Kampanjer? Tactik? Initiativ? Verksamheter? Händelser?
   ...
   * Har vi några överlappande kampanjer för samma målgrupp?
   * Vad har vi för budget för den kampanjen, taktiken, aktiviteten eller händelsen?
...
* ⛔ Lägg inte till en ny posttyp om de data du lagrar bara är relevanta för en enskild posttyp.
  ...
  En **Campaign**-posttyp kan till exempel ha ett envalsfält med namnet **Kampanjstorlek** som bara är relevant när det är direkt kopplat till en viss kampanj.
...
* ✅ Kom ihåg att definiera 2 datumfält för dina poster. Du kan bara skapa en tidslinjevy om du har minst två datumfält kopplade till en posttyp. Vissa poster kanske inte visas i tidslinjevyn när start- eller slutdatumet eller båda inte har några värden och när startdatumet är efter slutdatumet.
...
Använd delningsfunktionen för att ge lämplig behörighet till medarbetarna för vyer och arbetsytor.

#### Hur hanterar jag behörigheter till arbetsytor?

* ✅ När du skapar en **arbetsyta** är den bara tillgänglig för dig. Ingen annan kan hitta det utan systemadministratörer. När arbetsytan har definierats och du är redo att ta med teamet för att starta samarbetet, måste du dela den med dem och definiera deras behörighetsnivå.
...
* ✅ Alla användare med behörigheten Hantera på arbetsytan kan skapa eller redigera ett begärandeformulär. Kontrollera att användarens behörigheter är korrekt tilldelade för att tillåta den här funktionen.
...
* ✅ Sändningsbehörigheter beror på inställningarna som du konfigurerar för varje formulär.
  ...
  Du kan välja mellan följande tre delningsalternativ:
   ...
   * **Alla med länken:** Gör det möjligt för alla som har formulärlänken att skicka en begäran.
   * **Förfallodatum:** Se till att du anger ett förfallodatum för den offentliga länken för att förbättra säkerheten.
