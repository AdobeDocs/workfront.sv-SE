...
* Ett Workfront Planning Prime-paket som innehåller följande funktioner:

   * Obegränsade arbetsytor
   * 500 000 poster per arbetsyta
   * 2 miljoner totala arbetsytor
   * Globala posttyper
* Exempeldata som ger dig en idé om var du ska börja
* AI-styrd introduktion där du kan använda vanligt språk eller överföra en befintlig artefakt så genererar Planning en anpassad struktur med hjälp av AI. Detta skapar automatiskt arbetsytor, posttyper, fält och vyer.
...
Alla användare i organisationen får följande Workfront Planning-paket och behörighetsnivå för Workfront Planning under testperioden:

* **Mellan 2 mars och 1 maj 2026**:

  Oavsett licensnivå för Workfront eller Workflow får du en Workfront Planning Prime-licens när du godkänner testversionen av Workfront Planning.

  Användarna i ditt system får följande behörigheter till arbetsytorna i Planning-området under den kostnadsfria provperioden:

   * Alla systemadministratörer har behörigheten Hantera för arbetsytorna jag är på och fliken Alla arbetsytor.
   * Alla andra användare har behörigheten Visa i området Arbetsytor, men systemadministratören kan ge dem behörigheten Hantera för arbetsytor som visas där.
   * Alla användare, inklusive systemadministratören, har behörighet att visa på fliken Exempelarbetsytor i planeringsområdet.
...
1. (Villkorligt) Om du inte är systemadministratör följer du den banderoll i appen som innehåller information om testversionen av **Workfront Planning** och klickar sedan på **Läs mer**.
   ...
   Läs mer om testversionen av Workfront Planning och om Workfront Planning i den här artikeln.

### Delta i testversionen av Planning mellan 2 mars och 1 april 2026
...
1. Gör något av följande:
   ...
   * Gå till området **Workfront Notifications** i skärmens övre högra hörn och klicka sedan på **All Announcements** och sök efter meddelandet från meddelandecentret om testversionen av Workfront Planning
...
1. Klicka på **Acceptera** när du har granskat avtalet.
   ...
   * Planeringsområdet läggs till i huvudmenyn för dig och alla användare i systemet och visar en **utvärderingsindikator**.
   * Som systemadministratör får du Hantera-åtkomst till fliken **Exempelarbetsytor** i planeringsområdet.
   * Standardanvändare får Visa-åtkomst till fliken **Exempelarbetsytor** i Planering och kan skapa egna arbetsytor, posttyper, poster, fält och vyer och dela dem med andra.
   * Alla andra användare får Visa-åtkomst till fliken **Exempelarbetsytor** i planeringsområdet och kan få åtkomst till andra arbetsytor när andra delar dem med dem.
