...
I den här artikeln listas de funktioner som lanserades i början av Workfront Planning, 2024, före den allmänna tillgänglighetsutgåvan den 28 augusti 2024.
...
* Med Workfront Planning Plus får du:
   ...
   * 2 miljoner totalt antal poster för din instans.
...
Förhandsgranska: 21 augusti 2024
...
* Beroende på hur det är konfigurerat kan begärandeformuläret visa alla fält av posttyp, förutom fält av följande typer:
...
### Bevara den senast visade tidsbildrutan i tidslinjevyn
