...
1. Gör något av följande om du vill skapa poster i kalendervyn eller redigera deras datum:

   * Dubbelklicka var som helst i kalendern för att skapa en post.
   ...
   * Dra och släpp postfälten för att uppdatera deras position och datum. Om du flyttar posternas staplar uppdateras start- och slutdatumen omedelbart.
