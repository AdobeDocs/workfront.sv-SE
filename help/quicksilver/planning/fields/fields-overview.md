...
* Du kan skapa fält manuellt eller automatiskt på följande sätt:
   ...
   * Manuellt:
      ...
      * Genom att importera posttyper med en Excel- eller CSV-fil. Mer information finns i [Skapa posttyper](/help/quicksilver/planning/architecture/create-record-types.md).
