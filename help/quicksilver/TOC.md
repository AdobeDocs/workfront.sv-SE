...
* Administration och konfiguration {#administration-and-setup}
   ...
   * Administration i Adobe Admin Console {#admin-in-admin-console}
      ...
      * [Så här fungerar Workfront produkt- och användarmigrering till Adobe Admin Console](administration-and-setup/adobe-admin-console/understand-wf-migration-to-admin-console.md)
