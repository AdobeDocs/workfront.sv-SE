...
* Administration och konfiguration {#administration-and-setup}
   ...
   * Lägg till användare {#add-users}
      ...
      * Hur åtkomstnivåer fungerar {#access-levels}
         ...
         * [Åtkomst till objekt per licenstyp](administration-and-setup/add-users/access-levels-and-object-permissions/access-to-objects-and-areas-by-license-type.md)
...
* Grundläggande om Adobe Workfront {#basics}
   ...
   * Uppdatera arbetsuppgifter och visa uppdateringar {#update-work-items-view-updates}
      ...
      * [Översikt över fliken Uppdateringar](workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md)
...
* Hantera resurser {#manage-resources}
   ...
   * Resurshantering {#resource-management}
      ...
      * [Borttagning av verktygen för resursplanering i Adobe Workfront](resource-mgmt/resource-mgmt-overview/deprecate-resource-scheduling.md)
      * [Migrera från resursschemaläggning till arbetsbelastningsutjämnaren](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
   ...
   * Resursplanering {#resource-scheduling}
...
* Adobe Workfront-mål {#adobe-workfront-goals}
   ...
   * Målgranskning och avsnitten om Adobe Workfront-mål {#goal-review-and-adobe-workfront-goals-sections}
      ...
      * [Granska målen i avsnittet Adobe Workfront Goals Pulse](workfront-goals/goal-review-and-workfront-goals-sections/review-goals-in-pulse.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Workfront Fusion Apps och deras moduler {#fusion-apps-and-modules}
      ...
      * [Intacctmoduler](workfront-fusion/apps-and-their-modules/intacct-modules.md)
