...
* Produktmeddelanden {#product-announcements}
   ...
   * Produktreleaser {#product-releases}
      ...
      * 2026 Q3-utgåvan {#release-26-q3}
         ...
         * [Förbättringar av dokument i det tredje kvartalet 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-documents.md)
         * [Tredje kvartalet 2026 Begära förbättringar](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-requests.md)
      ...
      * Aktivitet för att frisläppa Adobe Workfront-mål {#goals-release}
         ...
         * Mål med version 21.2 {#goals-21-2}
            ...
            * [Aktivitet för Adobe Workfront Target 21.2-utgåvan: Vecka 19 april 2021](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-19.md)
            * [Aktivitet för Adobe Workfront Target 21.2-utgåvan: Vecka 5 april 2021](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-5.md)
            * [Aktivitet för Adobe Workfront Target 21.2-utgåvan: Vecka 15 februari 2021](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-feb-15.md)
      ...
      * Versionsaktivitet för Workfront Proof {#proof-release}
         ...
         * [Aktivitet: Vecka 17 maj 2021](product-announcements/product-releases/workfront-proof-release-activity/wp-release-may-17.md)
         * [Aktivitet: Vecka 29 november 2021](product-announcements/product-releases/workfront-proof-release-activity/wp-release-22-1.md)
...
* Administration och konfiguration {#administration-and-setup}
   * [Administration och konfiguration: artikelindex](administration-and-setup/administration-and-setup.md)
   ...
   * Konfigurera Workfront {#set-up-wf}
      ...
      * Konfigurera systemstandardinställningar {#configure-system-defaults}
         * [Konfigurera systemstandardvärden: artikelindex](administration-and-setup/set-up-workfront/configure-system-defaults/configure-system-defaults.md)
   ...
   * Anpassa Adobe Workfront {#customize}
      ...
      * Egna formulär {#custom-forms}
         ...
         * Utforma ett anpassat formulär {#design-a-form}
            * [Utforma ett formulär: artikelindex](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form-toc.md)
...
* Grundläggande om Adobe Workfront {#basics}
   * [Adobe Workfront grunder: artikelindex](workfront-basics/workfront-basics.md)
   ...
   * Navigera i Adobe Workfront {#navigate}
      ...
      * [Förstå navigeringen för en användare med en Light-license](workfront-basics/navigate-workfront/workfront-navigation/reviewer-global-navigation-bar.md)
   ...
   * Prioriteringar {#priorities}
      * [Prioriteringar: artikelindex](workfront-basics/priorities/priorities-toc.md)
   ...
   * Startsida {#home}
      ...
      * Använda området Hem {#use-home-area}
         * [Använd området Hem: artikelindex](workfront-basics/using-home/using-the-home-area/use-the-home-area.md)
   ...
   * Uppdatera arbetsuppgifter och visa uppdateringar {#update-work-items-view-updates}
      * [Uppdatera arbetsuppgifter och visa uppdateringar: artikelindex](workfront-basics/updating-work-items-and-viewing-updates/update-work-items-and-view-updates.md)
...
* Agile {#agile}
   ...
   * Använd Agile-planeringsverktygen i ritytorna {#agile-planning-boards}
      * [Översikt över flexibla planeringsverktyg: artikelindex](agile/use-boards-agile-planning-tools/agile-planning-tools-overview.md)
...
* Hantera arbete {#manage-work}
   ...
   * Projekt {#projects}
      ...
      * Hantera projekt {#manage-projects}
         ...
         * [Översikt över dokumenthantering för projekt och relaterade objekt](manage-work/projects/manage-projects/manage-documents-on-projects.md)
   ...
   * Uppgifter {#tasks}
      ...
      * Aktivitetsbegränsningar {#task-constraints}
         ...
         * [Översikt över uppgiftsbegränsning: Starta senast](manage-work/tasks/task-constraints/start-no-later-than.md)
      ...
      * Typ av aktivitetsvaraktighet och varaktighet {#task-duration-and-duration-types}
         * [Typ av aktivitetsvaraktighet och varaktighet: artikelindex](manage-work/tasks/taskdurtn/task-duration-duration-type.md)
...
* Rapportering {#reporting}
   ...
   * Kontrollpaneler på arbetsytan {#canvas-dashboards}
      ...
      * Skapa instrumentpaneler {#create-dashboards}
         * [Skapa arbetsytans kontrollpaneler: artikelindex](/help/quicksilver/reports-and-dashboards/canvas-dashboards/create-dashboards/create-dashboards-article-index.md)
      ...
      * Lägg till rapporter {#add-reports}
         * [Lägg till rapporter: artikelindex](/help/quicksilver/reports-and-dashboards/canvas-dashboards/add-reports/add-reports-toc.md)
   ...
   * Rapporter {#reports}
      ...
      * Beräknade anpassade data i rapporter {#calculated-custom-data}
         ...
         * [Exempel på beräknat anpassat fält: visa en tidsstämpel i ett anpassat formulär](reports-and-dashboards/reports/calc-cstm-data-reports/example-status-timestamp-in-calculated-field.md)
...
* Granska och godkänn arbetet {#review-and-approve-work}
   ...
   * Enhetliga godkännanden {#document-reviews-and-approvals}
      ...
      * Ställ in och hantera godkännande av tillgångar och dokument {#manage-asset-review-and-approval}
         * [Konfigurera och hantera enhetliga godkännanden: artikelindex](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/set-up-and-manage-doc-asset-approvals-toc.md)
      ...
      * Granska och godkänn resurser och dokument {#review-and-approve-documents}
         * [Granska och godkänn dokument: artikelindex](review-and-approve-work/document-reviews-and-approvals/review-and-approve-documents/review-documents-toc.md)
   ...
   * Korrektur {#proofing}
      ...
      * Korrektur - översikt {#proofing-overview}
         * [Korrekturöversikt: artikelindex](review-and-approve-work/proofing/proofing-overview/proofing-basics.md)
      ...
      * Använda Desktop Proofing Viewer {#use-the-desktop-proofing-viewer}
         * [Använd Desktop Proofing Viewer: artikelindex](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/use-desktop-proofing-viewer.md)
      ...
      * Granska korrektur i Adobe Workfront {#review-proofs-in-workfront}
         ...
         * Granska ett korrektur {#review-a-proof}
            * [Granska ett bevis: artikelindex](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-a-proof.md)
         ...
         * Fatta ett beslut om ett bevis {#make-decision-on-proof}
            * [Fatta ett beslut om ett bevis: artikelindex](review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decision-on-proof.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   * [Allmän information och artikelindex för Adobe Workfront Planning](planning/planning-information.md)
   ...
   * Begäranden om Adobe Workfront Planning {#adobe-workfront-planning-requests}
      * [Begäranden om Adobe Workfront Planning: artikelindex](planning/requests/requests-article-index.md)
   ...
   * Fristående Adobe Workfront Planning {#planning-standalone}
      * [Fristående Adobe Workfront Planning: artikelindex](planning/planning-sta/planning-sta-article-index.md)
...
* Workfront Proof {#workfront-proof}
   ...
   * Workfront Proof kontoadministration {#wf-proof-account-admin}
      ...
      * Tips, tricks och felsökning för kontoadministration i Workfront Proof {#ttt-wf-proof-account-admin}
         ...
         * [Frågor och svar: Migrering från Workfront Proof till EMEA](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/faq-wp-us-to-emea-mig.md)
