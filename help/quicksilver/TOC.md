...
* Produktmeddelanden {#product-announcements}
   ...
   * Produktreleaser {#product-releases}
      ...
      * 23.1 Utgåva {#release-23-1}
         ...
         * [Uppdateringar som både ser ut och känns under 23.1-releasetiden](product-announcements/product-releases/23.1-release-activity/23-1-look-and-feel-updates.md)
      * 22.4 Utgåva {#release-22-4}
         ...
         * [2.4 Förbättringar av administratörer](product-announcements/product-releases/22.4-release-activity/22-4-administrator-enhancements.md)
      ...
      * Aktivitet för att frisläppa Adobe Workfront-mål {#goals-release}
         ...
         * Mål med version 23.3 {#goals-23-3}
            ...
            * [Adobe Workfront Goals 23.3 Release Activity: Vecka 1 maj 2023](product-announcements/product-releases/goals-release-activity/goals-23-3-release/goals-23-3-may-5.md)
         * Mål med version 23.2 {#goals-23-2}
            ...
            * [Aktivitet för Adobe Workfront Target 23.2-utgåvan: Vecka 20 mars 2023](product-announcements/product-releases/goals-release-activity/goals-23-2-release/goals-march.md)
         * Mål med version 23.1 {#goals-23-1}
            ...
            * [Aktivitet för Adobe Workfront Target 23.1-utgåvan: Vecka 5 december 2023](product-announcements/product-releases/goals-release-activity/goals-23-1-release/goals-jan.md)
         * Mål med version 21.2 {#goals-21-2}
            ...
            * [Aktivitet för Adobe Workfront 21.2-versionen: Vecka 19 april 2021](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-19.md)
            * [Aktivitet för Adobe Workfront 21.2-versionen: Vecka 5 april 2021](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-5.md)
            * [Aktivitet för Adobe Workfront 21.2-versionen: Vecka 15 februari 2021](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-feb-15.md)
         * Mål med version 21.1 {#goals-21-1}
            ...
            * [Aktivitet för Adobe Workfront Target 21.1-utgåvan: Vecka 11 januari 2021](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-jan-11.md)
            * [Aktivitet för Adobe Workfront Target 21.1-utgåvan: Vecka 14 december 2020](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-dec-14.md)
            * [Aktivitet för Adobe Workfront Target 21.1-utgåvan: Vecka 30 november 2020](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-nov-30.md)
            * [Aktivitet för Adobe Workfront Target 21.1-utgåvan: Vecka 16 november 2020](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-nov-16.md)
      ...
      * Kvartalsvis publiceringsarkiv {#quarterly-release}
         ...
         * 20.3-utgåvan {#release-20-3}
            ...
            * [20.3 Förbättrad analys](product-announcements/product-releases/20.3-release-activity/20-3-analytics-enhancements.md)
         ...
         * 20.2-utgåvan {#release-20-2}
            ...
            * [2020.2 Resurshanteringsförbättringar: Utjämning av arbetsbelastning](product-announcements/product-releases/2020.2.-release-activity/2020.2-resource-management.md)
...
* Administration och konfiguration {#administration-and-setup}
   ...
   * Lägg till användare {#add-users}
      ...
      * Konfigurera åtkomst till Workfront {#configure-access}
         ...
         * [Bevilja åtkomst till Workfront-mål](administration-and-setup/add-users/configure-and-grant-access/grant-access-goals.md)
   ...
   * Anpassa Adobe Workfront {#customize}
      ...
      * Layoutmallar {#layout-templates}
         ...
         * [Workfront](administration-and-setup/customize-workfront/use-layout-templates/brand-wf-using-a-layout-template.md)
      ...
      * Status och prioritetsetiketter {#statuses-priority-labels}
         ...
         * [Skapa anpassade statusvärden](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/use-custom-statuses-as-default-statuses.md)
   ...
   * Hantera Adobe Workfront {#manage-wf}
      ...
      * Spark-Starts {#kick-starts}
         ...
         * [Exportera Workfront-data via Quick-Starts](administration-and-setup/manage-workfront/using-kick-starts/export-data-from-wf-via-kick-starts.md)
         ...
         * [Scenario: Företag och grupp](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-company-group-role-user-prep.md)
         * [Scenario: Importera anpassade fält med flera alternativ till Workfront](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-multiple-option-custom-field-import.md)
         * [Scenario: Objektimport](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-simple-project-task-import-prep.md)
   ...
   * Tips, tricks och felsökning för administration och konfiguration {#admin-setup-tips}
      ...
      * [Det gick inte att verifiera den digitala XML-signaturen](administration-and-setup/tips-tricks-and-troubleshooting/error-message-couldnt-validate-xml-digital-signature.md)
...
* Grundläggande om Adobe Workfront {#basics}
   ...
   * Startsida {#home}
      ...
      * Använda området Hem {#use-home-area}
         ...
         * [Visa objekt i arbetslistan i hemområdet](workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md)
         ...
         * [Skapa arbetsobjekt från hemområdet](workfront-basics/using-home/using-the-home-area/create-work-items-in-home.md)
   ...
   * Hantera ditt konto och din profil {#manage-account-profile}
...
* Hantera arbete {#manage-work}
   ...
   * Projekt {#projects}
      ...
      * Planera ett projekt {#plan-a-project}
         ...
         * [Översikt över projektteamet](manage-work/projects/planning-a-project/project-team-overview.md)
      ...
      * Definiera ett affärsärende {#define-business-case}
         ...
         * [Översikt över ekonomiska ärenden](manage-work/projects/define-a-business-case/business-case-finances.md)
         ...
         * [Budgetresurser i affärsärendet med hjälp av resursplaneraren](manage-work/projects/define-a-business-case/budget-resources-in-business-case-use-resource-planner.md)
   ...
   * Problem {#issues}
      ...
      * Konvertera problem {#convert-issues}
         ...
         * [Översikt över upplösta och upplösta objekt](manage-work/issues/convert-issues/resolving-and-resolvable-objects.md)
...
* Rapportering {#reporting}
   ...
   * Rapporter {#reports}
      ...
      * Beräknade anpassade data i rapporter {#calculated-custom-data}
         ...
         * [Översikt över IF-satser](reports-and-dashboards/reports/calc-cstm-data-reports/if-statements-overview.md)
         * [Exempel på beräknat anpassat fält: visa den som har skapat ett ärende i det anpassade formuläret](reports-and-dashboards/reports/calc-cstm-data-reports/custom-field-manager-issue-creator-on-issue-form.md)
   ...
   * Kontrollpaneler {#dashboards}
      ...
      * Förstå paneler {#understand-dashboards}
...
* Granska och godkänn arbetet {#review-and-approve-work}
   ...
   * Korrektur {#proofing}
      ...
      * Språköversikt {#proofing-overview}
         ...
         * [Översikt över filtyper och storleksbegränsningar som stöds](review-and-approve-work/proofing/proofing-overview/supported-proofing-file-types.md)
...
* Adobe Workfront Scenario Planner {#scenario-planner}
   ...
   * [Skapa och jämföra planscenarier i scenarioplanen](scenario-planner/create-and-compare-scenarios-for-a-plan.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Kom igång med Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      ...
      * [Skapa ett scenario för övningsautomatisering i Adobe Workfront Fusion](workfront-fusion/get-started/create-a-practice-automation-scenario.md)
   ...
   * Funktioner i Adobe Workfront Fusion {#functions-in-fusion}
   ...
   * Scenarier i Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * [Exempel på Adobe Workfront Fusion-scenario: Koppla e-post, textparser och Google-blad](workfront-fusion/scenarios/example-connect-email-text-parser-gsheets.md)
   ...
   * Workfront Fusion Apps och deras moduler {#fusion-apps-and-modules}
      ...
      * [Google Forms-moduler](workfront-fusion/apps-and-their-modules/google-forms-modules.md)
...
* Adobe Workfront Integrations {#adobe-workfront-integrations}
   ...
   * Adobe Workfront för Outlook {#workfront-for-outlook}
      ...
      * [Aktivera Outlook för Office för användning med Adobe Workfront och SAML 2.0](workfront-integrations-and-apps/using-workfront-with-outlook/enable-outlook-for-office-for-use-with-wf-and-saml-2.md)
   * Adobe Workfront för Microsoft Teams {#workfront-for-microsoft-teams}
      ...
      * [Få tillgång till Adobe Workfront från Microsoft Teams](workfront-integrations-and-apps/using-workfront-with-microsoft-teams/access-workfront-from-ms-teams.md)
   ...
   * Adobe Workfront för Slack {#workfront-for-slack}
      ...
      * [Hantera ditt arbete och godkännanden från Slack](workfront-integrations-and-apps/using-workfront-with-slack/manage-your-work-and-approvals-from-slack.md)
   ...
   * Adobe Workfront med Anaplan {#workfront-with-anaplan}
      ...
      * [Skicka Adobe Workfront-utgifter till ett listobjekt i Anaplan](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-expenses-to-anaplan-list-item.md)
...
* Workfront Proof {#workfront-proof}
   ...
   * Kom igång med Workfront Proof {#get-started-wf-proof}
      ...
      * Vanliga frågor om Workfront-korrektur {#wf-proof-faq}
         * [Workfront Proof - vanliga frågor](workfront-proof/wp-getstarted/faqs/faqs.md)
   ...
   * Arbeta med korrektur och filer i Workfront Proof {#work-with-proofs-in-wf-proof}
      ...
      * Hantera ditt arbete {#manage-your-work}
         ...
         * [Visa status och förlopp för ett korrektur i Workfront](workfront-proof/wp-work-proofsfiles/manage-your-work/view-progress-and-status-of-proof.md)
      ...
      * Granska korrektur i Web Proofing Viewer {#review-proofs-web-proofing-viewer}
   ...
   * Kontoadministration för Workfront Proof {#wf-proof-account-admin}
      ...
      * Hantera säkerhet {#manage-security}
         ...
         * [Korrektur för säkerhet i Workfront Proof](workfront-proof/wp-acct-admin/managing-security/proof-security-in-workfront-proof.md)
   ...
   * Workfront Korrektur för tekniker {#wf-proof-tech-corner}
      ...
      * Felsökning i Workfront Proof {#troubleshooting-wf-proof}
         ...
         * [Förstå hur cache och cookies påverkar Workfront-korrektur](workfront-proof/wp-tech-corner/troubleshooting/how-cache-cookies-affect-pv.md)
...
* Adobe Workfront API {#adobe-workfront-api}
   ...
   * API-anteckningar {#api-notes}
      * [API-anteckningar](wf-api/api/api.md)
   ...
   * Document Webhooks API {#document-webhooks-api}
      * [API-artiklar för dokumentwebbhotell](wf-api/doc-wbhks-api/document-webhooks-api.md)
