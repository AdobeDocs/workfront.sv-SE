...
Workfront beräknar dessa värden med hjälp av följande:
...
1. Dubbelklicka på värdet i **Resultatindexmetod** för att redigera det.
1. Välj bland följande alternativ i dialogrutan **Resultatindexmetod** fält:
