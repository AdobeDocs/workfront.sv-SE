...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td>I tid</td> 
   <td> Status för ett projekt är <strong>I tid</strong> if:<ul><li>Om både Planerat och Beräknat slutförandedatum är tidigare än eller lika med projektets Planerat slutförandedatum</li></ul> <p> <img src="assets/project-on-time-progress-status-350x69.png" style="width: 350;height: 69;"> </p> </td> 
  </tr> 
  <tr> 
   <td>Risk</td> 
   <td> Status för ett projekt är <strong>Risk</strong> if <strong>alla</strong> av följande är sant:<ul><li>Både beräknade och planerade slutförandedatum finns i framtiden</li><li> Både beräknade och planerade slutförandedatum är senare än det planerade slutförandedatumet</li><li> Det beräknade slutförandedatumet är senare än det planerade slutförandedatumet</li></ul><p> <img src="assets/project-at-risk-progress-status-350x67.png" style="width: 350;height: 67;"> </p> </td> 
  </tr> 
  <tr> 
   <td>Bakom</td> 
   <td> Status för ett projekt är <strong>Bakom</strong> if <strong>alla</strong> av följande är sant:<ul><li>Både beräknade och planerade slutförandedatum finns i framtiden</li><li> Både beräknade och planerade slutförandedatum är senare än projektets planerade slutförandedatum</li><li> Det beräknade slutförandedatumet är inte senare än det planerade slutförandedatumet</li></ul> <p> <img src="assets/project-behind-progress-status-350x67.png" style="width: 350;height: 67;"> </p> </td> 
  </tr> 
  <tr> 
   <td>Sena</td> 
   <td> 
     Status för ett projekt är <strong>Sena</strong> if <strong>antingen</strong> av följande är sant:<ul><li>Projektet är färdigt och det faktiska slutförandedatumet är senare än det planerade slutförandedatumet <p> <img src="assets/project-late-progress-status-350x66.png" style="width: 350;height: 66;"> </p> </li> 
