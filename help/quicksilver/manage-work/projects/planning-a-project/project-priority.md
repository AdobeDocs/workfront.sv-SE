...
* **Fältet Projektprioritet**: Du kan tilldela en prioritet till ett projekt manuellt.

   Mer information om fältet Projektprioritet finns i avsnittet [Överväganden om projektprioritet](#considerations-about-project-priority) i den här artikeln.
...
Du kan koppla en prioritet till projekt i Workfront. Uppgifter och frågor har också prioritet. Om du anger en prioritet för projektet kommunicerar det med alla i systemet hur viktigt det är.
...
* När du uppdaterar fältet Prioritet för ett projekt överförs den här prioriteten inte till Portfolio-optimering eller Resursplanering. 
