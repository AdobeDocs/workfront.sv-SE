...
title: Ange spårningsläge för uppgifter
description: Spårningsläget för en aktivitet avgör hur aktivitetens förloppsstatus uppdateras i Adobe Workfront.
author: Alina
...
1. Välj bland följande alternativ:
   ...
   * Användaren måste uppdatera (det här är standardalternativet)
   * Anta i tid
