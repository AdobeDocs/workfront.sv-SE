...
* Varje projekt får en poäng när deras [!UICONTROL Business Cases] fylls i enligt de kriterier som de matchar i [!UICONTROL Portfolio Optimizer]. Låga eller höga justeringsprojekt får till exempel högre poäng.
  ...
  Mer information om hur du beräknar portföljoptimeringspoängen för ett projekt finns i [Översikt över [!UICONTROL Portfolio Optimizer] Poäng](../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-score.md).
...
* Du kan prioritera projekt manuellt i [!UICONTROL Portfolio Optimizer], med beaktande av all information om dem. Detta inkluderar till exempel ekonomiska data, anpassning till deras styrkort och avkastning.
...
* **[!UICONTROL Portfolio Finances for Selected Projects]**: I det här området visas ekonomisk information som samlats in från de projekt som valts i [!UICONTROL Portfolio Optimizer]. Du kan lägga till eller ta bort projekt och förstå hur detta påverkar portföljens ekonomi genom att visa informationen i det här området.
