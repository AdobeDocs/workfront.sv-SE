...
1. Det kan vara bra att ange information i följande avsnitt:
   ...
   * [[!UICONTROL Comment]](#comment)
   ...
   >[!TIP]
   >
   >Om du vill beräkna om anpassade fält för flera program samtidigt markerar du flera program i en lista och klickar på menyn **Mer** ![Mer](assets/more-icon.png) överst i listan och sedan på **Beräkna om uttryck**.
