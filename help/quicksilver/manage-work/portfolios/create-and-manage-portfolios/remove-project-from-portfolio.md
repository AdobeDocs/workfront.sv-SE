...
Du kan även ta bort projekt från en portfölj som också tar bort dem från [!DNL Adobe Workfront].
...
1. Gå till Portfolio och klicka **[!UICONTROL Projects]** i den vänstra panelen.
...
1. Klicka på någon av **[!UICONTROL Delete]** för att ta bort projektet från [!DNL Workfront], eller **[!UICONTROL Remove]** **[!UICONTROL from Portfolio]** för att ta bort den från markerad Portfolio.
