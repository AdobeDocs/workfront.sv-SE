...
1. Markera det anpassade formulär som du vill ändra namn på och klicka sedan på **Redigera** <span class="preview">eller ![Ikonen Redigera](assets/edit-icon2.png).</span>
