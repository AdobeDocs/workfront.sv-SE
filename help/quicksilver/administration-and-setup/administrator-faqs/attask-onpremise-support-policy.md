...
description: Adobe Workfront flyttade till en 100 % Software-As-A-Service-modell och slutade sälja program på plats den 31 december 2011. 2014 stöds inte längre AtTask OnPremise, med undantag för licensnyckelrelaterade problem. Det lokala programmet är inte längre tillgängligt för hämtning eller installation.
...
Adobe Workfront flyttade till en 100 % Software-As-A-Service-modell och slutade sälja program på plats den 31 december 2011. 2014 stöds inte längre AtTask OnPremise, med undantag för licensnyckelrelaterade problem. Det lokala programmet är inte längre tillgängligt för hämtning eller installation.
...
1. Byt namn på den aktuella filen license.key (finns i mappen AtTaskDoc).
