...
>
>Om du vill ändra din Adobe Workfront-domän om din organisation har anslutit sig till Adobe Admin Console går du till [Konfigurera domäner](https://helpx.adobe.com/enterprise/using/set-up-identity.html#setup-domains).
>
