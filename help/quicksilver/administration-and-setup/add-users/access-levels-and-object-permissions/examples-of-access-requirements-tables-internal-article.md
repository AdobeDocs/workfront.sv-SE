...
1. Ta bort aktuell och äldre från licensraden. Se till att de är inkapslade <p> -taggar.
1. Ta bort alla DNL- och gränssnittskontrolltaggar.
1. Ta bort eventuell fet.
1. Ta bort eventuella asterisker.
...
>[!NOTE]
>
>Du kan fortsätta använda Adobe Workfront-mål om ditt företag har köpt det här paketet tidigare. Adobe Workfront-mål går inte att köpa längre.
...
## Åtkomstkrav för Adobe Workfront Automation and Integration
