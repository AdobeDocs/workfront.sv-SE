...
1. Klicka på kugghjulsikonen ![](assets/gear-icon-settings.png) på **Visa** eller **Redigera** till höger om Mallar och välj sedan de funktioner som du vill ge under **Finjustera inställningarna**.
