...
Som Adobe Workfront-administratör kan du använda en åtkomstnivå för att definiera en användares åtkomst till Resurshantering, vilket förklaras i [Översikt över åtkomstnivåer](../../../administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).
...
1. Klicka på kugghjulsikonen ![](assets/gear-icon-settings.png) på **Visa** eller **Redigera** till höger om Resurshantering och välj sedan de funktioner du vill bevilja under **Finjustera inställningarna**.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">Hantera resurspooler</td> 
...
* Användarens åtkomst till ekonomiska data, enligt beskrivningen i [Bevilja åtkomst till finansiella uppgifter](../../../administration-and-setup/add-users/configure-and-grant-access/grant-access-financial.md)
