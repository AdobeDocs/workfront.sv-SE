...
Som Adobe Workfront-administratör kan du använda en åtkomstnivå för att definiera en användares åtkomst till filtrerings-, vy- och grupperingskontrollerna för listor och rapporter, vilket förklaras i [Översikt över åtkomstnivåer](../../../administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).

Mer information om filter-, vy- och grupperingskontroller finns i [Rapportelement: filter, vyer och grupperingar](../../../reports-and-dashboards/reports/reporting-elements/reporting-elements-filters-views-groupings.md).
...
1. Klicka på kugghjulsikonen ![](assets/gear-icon-settings.png) på **Visa** eller **Redigera** till höger om Filter och sedan välja de funktioner du vill ge under **Finjustera inställningarna**.
