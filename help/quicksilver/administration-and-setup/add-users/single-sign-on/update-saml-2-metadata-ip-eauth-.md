...
1. Klistra in värdet från **entityID** till **Audience URI (SP Entity ID)** fält.

1. I XML-filen på den andra webbläsarfliken kopierar du värdet från **Plats** fält.
...
1. (Villkorligt) Om två flikar visas klickar du på **Nya SSO-providers** -fliken.
   ...
   >[!IMPORTANT]
   >
   >Ta inte bort dina befintliga inställningar för enkel inloggning i **Aktuell SSO-provider** tills ditt konto har uppdaterats till det förbättrade autentiseringsupplevelsen och den nya SSO-konfigurationen fungerar helt.
...
1. I **Mappa användarattribut** i **Katalogattribut** fält, typ **e-post**. (**E-postadress** är redan ifylld i **Workfront-användarattribut** fält.)
