...
>
>Instruktioner finns i [Hantera flera användare | Gruppera CSV-överföring](https://helpx.adobe.com/enterprise/using/bulk-upload-users.html) i Adobe-dokumentationen.
